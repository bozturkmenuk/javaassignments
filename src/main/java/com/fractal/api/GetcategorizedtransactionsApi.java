...
@Api(value = "getcategorizedtransactions", description = "the getcategorizedtransactions API")
public interface GetcategorizedtransactionsApi {

    Logger log = LoggerFactory.getLogger(GetcategorizedtransactionsApi.class);
